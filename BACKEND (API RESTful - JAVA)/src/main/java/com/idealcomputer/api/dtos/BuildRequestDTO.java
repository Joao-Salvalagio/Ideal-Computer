...
// DTO para criação e atualização de montagens.
// Resolve o problema de recebimento de dados simplificados do frontend,
// permitindo que o usuário envie apenas os IDs dos componentes escolhidos.
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class BuildRequestDTO {
    ...
    @JsonProperty("id_gpu") // Opcional (vídeo integrado)
    private Long idGpu;
    ...
    @JsonProperty("id_refrigeracao") // Opcional (cooler box)
